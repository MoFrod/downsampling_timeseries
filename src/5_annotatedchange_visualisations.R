...
ggplot(merged, 
  ...
  labs(x = "Time ID", y = "Time Value", title = "Annotated Change Time Series Data") +
...
sensitivity_joined_long$Method <- factor(sensitivity_joined_long$Method, levels = c("PercentageChangeSensitivity", "everyNthSensitivity", "CombinedSensitivity"))
