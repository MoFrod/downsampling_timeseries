...
A comparison of the most sensitive features for each time series type is shared in Annex G. It would be beneficial to explore this further as this variation may offer data practitioners a method for identifying subsets of features that best indicate the preservation of different time series.
...
\newpage
# Annex c: Original Nine Synthetic Time Series
...
\newpage
# Annex D: Coefficient of Variation for all `Catch22` Features
...
\newpage
# Annex E: The Statistical Properties of `Catch22` Features

\vspace{-2.8cm}
Table 3 provides an overview of the `catch22` features and their statistical properties @feature_book. 
...
knitr::kable(table_content, caption = "Catch22 Feature Overview") %>%
  kable_classic_2(full_width = F) %>%
...
table_content_cont <- matrix(
  c(
    ...
    "Self-affine scaling", "SC_FluctAnal_2_rsrangeﬁt_50_1_logi_ prop_r1", "LogarithmicTimescaleFluctuation", "Rescaled range fluctuation analysis (low-scale scaling)",
...
# Create the table with the title
knitr::kable(table_content_cont, caption = "Catch22 Feature Overview Continued: ") %>%
  kable_classic_2(full_width = F) %>%
    column_spec(1, width = "0.7in") %>%
...
# Annex F: Variation of `Catch22` Features across Time Series Types
...
```{r LongestDecrease, echo=FALSE, message=FALSE, warning=FALSE, fig.height=4.1, fig.with=3}
# Create the scaled difference line graph for SB_BinaryStats_diff_longstretch0
ggplot(filtered_df %>%
         filter(names == "LongestPeriod_Decreases"), 
       aes(x = as.numeric(vol), y = scaled, color = method)) +
...
```{r FirstMinimum2, echo=FALSE, message=FALSE, warning=FALSE, fig.height=4.1, fig.with=3}
...
ggplot(filtered_df %>%
  ...
  scale_x_reverse() +
  theme_minimal() +
  theme(text = element_text(family = "Times"), plot.title = element_text(hjust = -0.39, size=11), legend.position = "top", legend.justification = c(-0.04, 1)) +
...
```{r AutoMutalFunction, echo=FALSE, message=FALSE, warning=FALSE, fig.height=4.1, fig.with=3}
...
```{r LongestGreater, echo=FALSE, message=FALSE, warning=FALSE, fig.height=4.1, fig.with=3}
...
ggplot(filtered_df %>%
  ...
  scale_x_reverse() +
  theme_minimal() +
  theme(text = element_text(family = "Times"), plot.title = element_text(hjust = -0.8, size=11), legend.position = "top", legend.justification = c(-0.04, 1)) +
...
```{r ApproxScale, echo=FALSE, message=FALSE, warning=FALSE, fig.height=4.1, fig.with=3}
...
```{r FirstPeak, echo=FALSE, message=FALSE, warning=FALSE, fig.height=4.1, fig.with=3}
...
```{r MAE, echo=FALSE, message=FALSE, warning=FALSE, fig.height=4.1, fig.with=3}
...
\newpage
# Annex G: Most Sensitive `Catch22` Features for each Time Series Type
...
ggplot(subset_filtered_df %>%
  ...
  scale_x_reverse() +
  theme_minimal() +
  theme(text = element_text(family = "Times"), plot.title = element_text(hjust = -0.1, size=11), legend.position = "top", legend.justification = c(-0.04, 1)) +
  labs(x = "Volume of Data", y = "Scaled Difference", color = "Method", title = "Figure 33: Variation of Catch22 Features: Time Series 100") +
  facet_wrap(~ names, ncol = 3)
```
...
ggplot(subset_filtered_df %>%
  ...
  theme_minimal() +
  theme(text = element_text(family = "Times"), plot.title = element_text(hjust = -0.1, size=11), legend.position = "top", legend.justification = c(-0.04, 1)) +
  labs(x = "Volume of Data", y = "Scaled Difference", color = "Method", title = "Figure 34: Variation of Catch22 Features: Time Series 200") +
  facet_wrap(~ names, ncol = 3)
```
...
ggplot(subset_filtered_df %>%
  ...
  theme_minimal() +
  theme(text = element_text(family = "Times"), plot.title = element_text(hjust = -0.1, size=11), legend.position = "top", legend.justification = c(-0.04, 1)) +
  labs(x = "Volume of Data", y = "Scaled Difference", color = "Method", title = "Figure 35: Variation of Catch22 Features: Time Series 300") +
  facet_wrap(~ names, ncol = 3)
```
...
ggplot(subset_filtered_df %>%
  ...
  theme_minimal() +
  theme(text = element_text(family = "Times"), plot.title = element_text(hjust = -0.1, size=11), legend.position = "top", legend.justification = c(-0.04, 1)) +
  labs(x = "Volume of Data", y = "Scaled Difference", color = "Method", title = "Figure 36: Variation of Catch22 Features: Time Series 400") +
  facet_wrap(~ names, ncol = 3)
```
...
ggplot(subset_filtered_df %>%
  ...
  theme_minimal() +
  theme(text = element_text(family = "Times"), plot.title = element_text(hjust = -0.1, size=11), legend.position = "top", legend.justification = c(-0.04, 1)) +
  labs(x = "Volume of Data", y = "Scaled Difference", color = "Method", title = "Figure 37: Variation of Catch22 Features: Time Series 500") +
  facet_wrap(~ names, ncol = 3)
```
...
ggplot(subset_filtered_df %>%
  ...
  theme_minimal() +
  theme(text = element_text(family = "Times"), plot.title = element_text(hjust = -0.1, size=11), legend.position = "top", legend.justification = c(-0.04, 1)) +
  labs(x = "Volume of Data", y = "Scaled Difference", color = "Method", title = "Figure 38: Variation of Catch22 Features: Time Series 600") +
  facet_wrap(~ names, ncol = 3)
```
...
ggplot(subset_filtered_df %>%
  ...
  theme_minimal() +
  theme(text = element_text(family = "Times"), plot.title = element_text(hjust = -0.1, size=11), legend.position = "top", legend.justification = c(-0.04, 1)) +
  labs(x = "Volume of Data", y = "Scaled Difference", color = "Method", title = "Figure 39: Variation of Catch22 Features: Time Series 700") +
  facet_wrap(~ names, ncol = 3)
```
...
ggplot(subset_filtered_df %>%
  ...
  theme_minimal() +
  theme(text = element_text(family = "Times"), plot.title = element_text(hjust = -0.1, size=11), legend.position = "top", legend.justification = c(-0.04, 1)) +
  labs(x = "Volume of Data", y = "Scaled Difference", color = "Method", title = "Figure 40: Variation of Catch22 Features: Time Series 800A") +
  facet_wrap(~ names, ncol = 3)
```
...
ggplot(subset_filtered_df %>%
  ...
  theme_minimal() +
  theme(text = element_text(family = "Times"), plot.title = element_text(hjust = -0.1, size=11), legend.position = "top", legend.justification = c(-0.04, 1)) +
  labs(x = "Volume of Data", y = "Scaled Difference", color = "Method", title = "Figure 42: Variation of Catch22 Features: Time Series 800B") +
  facet_wrap(~ names, ncol = 3)
```
